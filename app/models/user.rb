class User < CouchRest::ExtendedDocument
  ...
  def create_responder(time = "45m")
    ...
    Twilio::Sms.message(from_number, self.phone_number, "The top meals are #{Restaurant.get(self.current_restaurant_id).top_meals.map{|m| m.name + " ("+m.rating.to_s+")"}.join(", ")}.")
